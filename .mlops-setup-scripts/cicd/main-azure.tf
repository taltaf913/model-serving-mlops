resource "databricks_group" "mlops-service-principal-group-staging" {
  display_name = "model-serving-mlops-service-principals"
...
module "azure_create_sp" {
  ...
  service_principal_name       = "model-serving-mlops-cicd"
  project_directory_path       = "/model-serving-mlops"
  azure_tenant_id              = var.azure_tenant_id
  service_principal_group_name = "model-serving-mlops-service-principals"
}
